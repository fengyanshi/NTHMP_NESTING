...
% input
foutput='/Volumes/DISK_2020_5/NTHMP_FL_PM_BR/Results/A3_GridA/output/';
...
starttime  = [5000];   % in seconds, adjust to truncate time series
stoptime=starttime+18000.0; % 5 hours

%stoptime   = [11000 11000];% Inf; % in sec. indicate Inf to include all.

coupling_filename={'coupling_A3_FL.txt'}
logfile='log_A3_AB.txt';
