...
% input
foutput='/Volumes/DISK_2020_5/NTHMP_FL_PM_BR/Results/A4_GridB/output/';
...
starttime  = [5000 5000];   % in seconds, adjust to truncate time series
stoptime=starttime+18000.0; % 5 hours

coupling_filename={'coupling_A4_BR.txt','coupling_A4_PM.txt'}
logfile='log_A4_AB_BR_PM.txt';
