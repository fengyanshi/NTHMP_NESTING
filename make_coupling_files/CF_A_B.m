...
% input
foutput='/Volumes/DISK_2020_5/NTHMP_FL_PM_BR/Results/CF_GridA/output/';
...
starttime  = [2000];   % in seconds, adjust to truncate time series
stoptime=starttime+18000.0; % 5 hours

%stoptime   = [11000 11000];% Inf; % in sec. indicate Inf to include all.

coupling_filename={'coupling_CF_FL.txt'}
logfile='log_CF_AB.txt';
