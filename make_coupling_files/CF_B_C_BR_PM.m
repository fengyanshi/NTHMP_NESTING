...
% input
foutput='/Volumes/DISK_2020_5/NTHMP_FL_PM_BR/Results/CF_GridB/output/';
...
starttime  = [2000 2000];   % in seconds, adjust to truncate time series
stoptime=starttime+18000.0; % 5 hours

coupling_filename={'coupling_CF_BR.txt','coupling_CF_PM.txt'}
logfile='log_CF_AB_BR_PM.txt';
