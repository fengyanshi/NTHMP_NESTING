...
% input
foutput='/Volumes/DISK_2020_5/NTHMP_FL_PM_BR/Results/CVV_GridB/output/';
...
starttime  = [24000 24000];   % in seconds, adjust to truncate time series
stoptime=starttime+18000.0; % 5 hours

coupling_filename={'coupling_CVV_BR.txt','coupling_CVV_PM.txt'}
logfile='log_CVV_AB_BR_PM.txt';
