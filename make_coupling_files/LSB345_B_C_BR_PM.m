...
% input
foutput='/Volumes/DISK_2020_5/NTHMP_FL_PM_BR/Results/LSB345_GridB/output/';
fgrid='/Users/fengyanshi/WORK/work/NTHMP_2022/make_stations/';
fcur='/Users/fengyanshi/WORK/work/NTHMP_2022/make_coupling_files/';

coupling_info=load([fgrid 'station_FL_BR_PM.txt']);
num_blocks=coupling_info(end,3)/4;

iscale=[18 18];  % spacial refine scale for all blocks
itscale = [2 2]; % coarsen time scale, skip x output time steps

starttime  = [30000 30000];   % in seconds, adjust to truncate time series
stoptime=starttime+18000.0; % 5 hours

coupling_filename={'coupling_LSB345_BR.txt','coupling_LSB345_PM.txt'}
logfile='log_LSB345_AB_BR_PM.txt';
