...
% input
foutput='/Volumes/DISK_2020_5/NTHMP_FL_PM_BR/Results/PRT_GridB/output/';
...
starttime  = [6000 6000];   % in seconds, adjust to truncate time series
stoptime=starttime+18000.0; % 5 hours

coupling_filename={'coupling_PRT_BR.txt','coupling_PRT_PM.txt'}
logfile='log_PRT_AB_BR_PM.txt';
